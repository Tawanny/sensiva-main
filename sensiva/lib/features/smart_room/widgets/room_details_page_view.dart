                ...
                child: ListView(
                  ...
                  children: [
                    SlideTransition(
                      ...
                      child: FadeTransition(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: LightsAndTimerSwitchers(room: category),
                            ),
                            width20,
                            Expanded(child: MusicSwitchers(room: category)),
                          ],
                        ),
                      ),
                    ),
                    ...
                    SlideTransition(
                      ...
                      child: FadeTransition(
                          opacity: _interval2,
                          child: LightIntensitySliderCard(room: category)),
                    ),
                    const SizedBox(height: 20),
                    SlideTransition(
                      position: Tween(
                      ...
                      child: FadeTransition(
                        opacity: _interval3,
                        child: AirConditionerControlsCard(room: category),
                      ),
                    ),
                  ],
                ),
